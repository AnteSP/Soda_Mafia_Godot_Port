...
namespace DialogueManagerRuntime
{
  public partial class ExampleBalloon : CanvasLayer
  {
	...
	static AudioStreamPlayer typeNoise;
	...
	private void _on_dialogue_label_spoke(string letter, int letter_index,float speed )
	{
		/*
	  GD.Print("pls?");
	  if(typeNoise != null){
	...
	public static void ChangeTypeNoise(AudioStreamPlayer newNoise)
	{
		typeNoise = newNoise;
	}
